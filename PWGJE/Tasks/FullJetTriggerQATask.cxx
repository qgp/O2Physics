...
struct JetTriggerQA {
  ...
  std::pair<std::vector<typename JetCollection::iterator>, std::vector<typename JetCollection::iterator>> fillJetQA(const JetCollection& jets, aod::JTracks const& tracks, selectedClusters const& clusters, const std::bitset<TriggerType_t::kNTriggers>& triggerstatus)
  {
    auto isTrigger = [&triggerstatus](TriggerType_t triggertype) -> bool {
      return triggerstatus.test(triggertype);
    };
             ...
             selectedClusters const& clusters)
  {
    ...
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::fullHigh) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighEMCAL)) {
      fillEventSelectionCounter(11);
      setTrigger(TriggerType_t::kEmcalGammaLow);
    }
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::fullHigh) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighDCAL)) {
      fillEventSelectionCounter(12);
      setTrigger(TriggerType_t::kDcalGammaLow);
    }
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::neutralHigh) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighEMCAL)) {
      fillEventSelectionCounter(13);
      setTrigger(TriggerType_t::kEmcalGammaVeryLow);
    }
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::neutralHigh) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighDCAL)) {
      fillEventSelectionCounter(14);
    }
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::fullHigh) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::neutralHigh)) {
      fillEventSelectionCounter(15);
    }
    if (JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighEMCAL) && JetDerivedDataUtilities::selectFullTrigger(collision, JetDerivedDataUtilities::JTrigSelFull::gammaHighDCAL)) {
